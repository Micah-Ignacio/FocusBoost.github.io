...
function updateAMPMIndicator(inputElement, indicatorElement) {
...
// Event handler for addEventFrom
addEventFrom.addEventListener("input", (e) => {
  ...
  // Call the function to update AM/PM indicator
  updateAMPMIndicator(addEventFrom, addEventFromIndicator);
});

// Event handler for addEventTo
addEventTo.addEventListener("input", (e) => {
  ...
  // Call the function to update AM/PM indicator
  updateAMPMIndicator(addEventTo, addEventToIndicator);
});
